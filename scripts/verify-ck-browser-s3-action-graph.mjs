...
const runtimeRoot = resolve(process.env.CK_RUNTIME_ROOT ?? 'var/work/runtime-v2-s3-staging');
...
const { buildEsp32S3Image } = await import('../packages/web/public/esp32/v2/image-builder.js');
