# ESP32 Xtensa Clang/LLD browser compiler notices

The package JavaScript wrapper is derived from the YoWASP Clang API. The
Espressif LLVM source, wasi-libc resources, and bundled `@yowasp/runtime`
